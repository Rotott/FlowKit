...
* **Rationale:** Separating the structural model from the execution logic ensures the codebase remains maintainable, testable, and easy to reason about.
...
* **Intent:** Maximize type safety and leverage modern C++ structures.
* **Rationale:** Catches architectural violations and bugs early during compilation rather than risking runtime crashes.
